    ...
    <table class="pt">
      ...
      <tbody>
        <tr>
          ...
          <td style="border:1px solid var(--g2);text-align:center"><div class="wn">1</div></td>
          <td style="border:1px solid var(--g2);text-align:center">1 Minggu</td>
        </tr>
        <tr>
          <td style="border:1px solid var(--g2)">Identitasku</td>
          <td style="border:1px solid var(--g2);text-align:center"><div class="wn">2</div></td>
          <td style="border:1px solid var(--g2);text-align:center">1 Minggu</td>
        </tr>
        <tr>
          <td style="border:1px solid var(--g2)">Tubuhku / Aurat</td>
          <td style="border:1px solid var(--g2);text-align:center"><div class="wn">3</div></td>
          <td style="border:1px solid var(--g2);text-align:center">1 Minggu</td>
        </tr>
        <tr>
          <td style="border:1px solid var(--g2)">Panca Indra</td>
          <td style="border:1px solid var(--g2);text-align:center"><div class="wn">4</div></td>
          <td style="border:1px solid var(--g2);text-align:center">1 Minggu</td>
        </tr>
        <tr>
          ...
          <td style="border:1px solid var(--g2);text-align:center"><div class="wn">5</div></td>
          <td style="border:1px solid var(--g2);text-align:center">1 Minggu</td>
        </tr>
        <tr>
          <td style="border:1px solid var(--g2)">Hari Besar Nasional</td>
          <td style="border:1px solid var(--g2);text-align:center"><div class="wn">6</div></td>
          <td style="border:1px solid var(--g2);text-align:center">1 Minggu</td>
        </tr>
        <tr>
          <td style="border:1px solid var(--g2)">Lambang Negara</td>
          <td style="border:1px solid var(--g2);text-align:center"><div class="wn">7</div></td>
          <td style="border:1px solid var(--g2);text-align:center">1 Minggu</td>
        </tr>
        <tr>
          <td style="border:1px solid var(--g2)">Elemen Bangsa / Budaya</td>
          <td style="border:1px solid var(--g2);text-align:center"><div class="wn">8</div></td>
          <td style="border:1px solid var(--g2);text-align:center">1 Minggu</td>
        </tr>
        <tr>
          <td colspan="4" style="border:1px solid var(--g2);text-align:center;font-weight:700;background:var(--g1)">JUMLAH</td>
          <td style="border:1px solid var(--g2);text-align:center;font-weight:700;background:var(--g1)">17 Minggu</td>
        </tr>
      </tbody>
    </table>
  </div>
