...
<div class="card">
  ...
  <div class="rc2">
    ...
    <div class="ig mt8">
      ...
      <div class="ib">
        ...
        <div class="iv" style="font-size:11.5px">Anak dapat mengenal Allah sebagai Tuhan melalui kegiatan kreatif...</div>
      </div>
    </div>
    <div class="ract">
      <button class="btn bo bsm">👁️ Lihat Detail</button>
      <button class="btn bo bsm" onclick="document.getElementById('mCRP').classList.add('on')">🖨️ Cetak</button>
    </div>
  </div>
  ...
  <div class="rc2">
    ...
    <div class="ig mt8">
      ...
      <div class="ib">
        <div class="ik">Tujuan</div>
        <div class="iv" style="font-size:11.5px">Anak mengenal lingkungan sekolah dan merasa nyaman belajar...</div>
      </div>
    </div>
    <div class="ract">
      <button class="btn bo bsm">👁️ Lihat Detail</button>
