    ...
    <div class="card">
        ...
        <div class="card mb16" style="border-color:var(--g2)">
            ...
            <div class="g3 mb16">
                ...
                <div class="ib">
                    ...
                    <div class="iv" style="color:var(--g6)">4</div>
                </div>
                <div class="ib">
                ...
                <div class="ib">
                    ...
                    <div class="iv">24 entri</div>
                </div>
                <div class="ib">
                    <div class="ik">RPPM Pending</div>
                    <div class="iv" style="color:var(--acc2)">2</div>
                </div>
                <div class="ib">
            ...
            <div class="pw">
                <div class="pb gr" style="width:67%"></div>
            </div>
        </div>
        ...
        <div class="card mb16" style="border-color:var(--g2)">
            ...
            <div class="g3 mb16">
                ...
                <div class="ib">
                    <div class="ik">Portofolio</div>
                    <div class="iv">20 entri</div>
                </div>
                <div class="ib">
                    <div class="ik">RPPM Pending</div>
                    <div class="iv" style="color:var(--acc2)">1</div>
                </div>
                <div class="ib">
                    <div class="ik">Progress</div>
                    <div class="iv">80%</div>
