...
<div class="card">
  ...
  <div class="card mb16" style="border-color:var(--g2)">
    ...
    <div class="graf-bar">
      ...
      <div class="graf-wrap"><div class="graf-fill pb gr" style="width:37%"><span class="graf-val">3</span></div></div>
      <div class="graf-pct">37%</div>
    </div>
    <div class="graf-bar">
      <div class="graf-label"><span class="ap a2">🏃 Fisik Motorik</span></div>
      <div class="graf-wrap"><div class="graf-fill pb bl" style="width:25%"><span class="graf-val">2</span></div></div>
      <div class="graf-pct">25%</div>
    </div>
    <div class="graf-bar">
      <div class="graf-label"><span class="ap a3">🧠 Kognitif</span></div>
      <div class="graf-wrap"><div class="graf-fill pb ye" style="width:25%"><span class="graf-val">2</span></div></div>
      <div class="graf-pct">25%</div>
    </div>
    <div class="graf-bar">
      <div class="graf-label"><span class="ap a6">🎨 Seni</span></div>
      <div class="graf-wrap"><div class="graf-fill pb or" style="width:12%"><span class="graf-val">1</span></div></div>
