    ...
    <div class="g4 mt16">
      <div class="pfc">
        ...
        <div class="pfb">
          ...
          <div class="pfnt">Ibrahim mendemonstrasikan urutan wudhu dengan baik dan benar di depan kelas...</div>
          <div class="fl fw g8 mt8">
            <span class="ap a1">🕌</span>
            <span class="ap a5">❤️</span>
          </div>
...
@push('scripts')
<script>
document.querySelectorAll('[data-porto]').forEach(function(btn) {
  btn.addEventListener('click', function() {
    var target = this.getAttribute('data-porto');
    this.closest('.tabs').querySelectorAll('.tbn').forEach(function(b){ b.classList.remove('on'); });
    this.classList.add('on');
    document.querySelectorAll('.porto-panel').forEach(function(p){ p.style.display = 'none'; });
