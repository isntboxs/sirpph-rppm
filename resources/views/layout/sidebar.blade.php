{{-- <aside class="sb">
    ...
    <nav class="sbn">
        ...
        <a class="ni {{ request()->routeIs('master_bentuk_alat') ? 'on' : '' }}"
            href="{{ route('master_bentuk_alat') }}">
        ...
        <a class="ni {{ request()->routeIs('validasi_kegiatan') ? 'on' : '' }}"
            href="{{ route('validasi_kegiatan') }}">
        ...
        <a class="ni {{ request()->routeIs('kumpulan_kegiatan') ? 'on' : '' }}"
            href="{{ route('kumpulan_kegiatan') }}">
...
<aside class="sb">
    ...
    <nav class="sbn">
        ...
        <div class="sns">Guru</div>
        <a class="ni" href="{{ route('kumpulan_kegiatan') }}"><span class="nic">🗂️</span> Kumpulan Kegiatan</a>
        ...
        <a class="ni" href="{{ route('portofolio_siswa') }}"><span class="nic">📸</span> Portofolio Siswa</a>
